...
object SettingsKey {
    ...
    const val TARN_RU_DIRECT = "tarn_ru_direct"
    const val TARN_RU_DIRECT_REMOTE_DOMAINS = "tarn_ru_direct_remote_domains"
    const val TARN_RU_DIRECT_REMOTE_DOMAINS_ETAG = "tarn_ru_direct_remote_domains_etag"
    const val TARN_RU_DIRECT_REMOTE_DOMAINS_LAST_REFRESH = "tarn_ru_direct_remote_domains_last_refresh"
    const val TARN_RU_DIRECT_REMOTE_DOMAINS_LAST_SUCCESS = "tarn_ru_direct_remote_domains_last_success"
    const val TARN_RECORD_FRAGMENT = "tarn_record_fragment"
    const val TARN_TLS_FINGERPRINT = "tarn_tls_fingerprint"
    const val TARN_DIRECT_DOMAINS = "tarn_direct_domains"
